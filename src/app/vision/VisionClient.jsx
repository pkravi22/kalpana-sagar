...
export default function VisionClient() {
  return (
    <div className="bg-[#FCFBF7] text-slate-800">
      <section className="relative hero-gradient text-white pt-8 pb-16 md:pt-8 md:pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -pt-8 md:px-16 relative z-10">
